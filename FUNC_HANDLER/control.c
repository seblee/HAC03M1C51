...
const u8 pageLevel[][2] = {
    ...
    {PAGE24, PASSWORDLEVEL3}, //  PASSWORD_PAGEJUMP_18_EVENT
    ...
    {PAGE34, PASSWORDLEVEL0}, //  PASSWORD_PAGEJUMP_22_EVENT
    ...
    {PAGE38, PASSWORDLEVEL2}, //  MAINTAIM PAGE
    ...
    {PAGE47, PASSWORDLEVEL3}, //  sysConfig
